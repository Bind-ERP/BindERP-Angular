...
export class WarehousesApi {
    ...
    /**
     * 
     * @summary Obtiene la lista de almacenes.
     ...
     */
    public warehousesGet (filter?: string, orderby?: string, top?: number, skip?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.WarehousePage> {
        const localVarPath = this.basePath + '/api/Warehouses';

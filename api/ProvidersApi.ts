...
export class ProvidersApi {
     ...
     * @param newProvider 
     */
    public providersAddProvider (newProvider: models.NewProvider, extraHttpRequestParams?: any ) : ng.IHttpPromise<string> {
        const localVarPath = this.basePath + '/api/Providers';

        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
        // verify required parameter 'newProvider' is not null or undefined
    ...
    /**
     * 
     * @summary Borrar Proveedor
     * @param id 
     */
    public providersDeleteByID (id: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/api/Providers/{id}'
     ...
     * @param provider 
     */
    public providersEditProvider (provider: models.EditProvider, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/api/Providers';
     ...
     */
    public providersGetProviders (filter?: string, orderby?: string, top?: number, skip?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ProviderListItemPage> {
        const localVarPath = this.basePath + '/api/Providers';
